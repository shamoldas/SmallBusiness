        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
					...
					echo "<td>";
                                            echo "<a href='readcontact.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'>View<span class='glyphicon glyphicon-eye-open'></span></a>";
                                            ...
                                            echo "<a href='deletecontact.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'>Delete<span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
